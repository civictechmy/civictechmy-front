    ...
    <li
      ...
      className={clx(
        ...
        isDisabled(type, year, type === "begin" ? selectedEnd : selectedStart)
          ? "dark:text-outlineHover-dark cursor-not-allowed text-outline hover:bg-white dark:hover:bg-black"
          : "cursor-pointer text-black hover:bg-washed dark:text-white dark:hover:bg-washed-dark",
      )}
      onClick={() => {
        if (
          !isDisabled(
      ...
      {({ open }) => {
        ...
        return (
          <>
            <Popover.Button
              className={clx(
                "flex items-center gap-1.5 rounded-md px-3 py-1.5 text-start text-sm font-medium text-black shadow-button dark:text-white",
            ...
            >
              <Popover.Panel
                className={clx(
                  "max-h-100 absolute z-20 mt-1 min-w-full overflow-clip rounded-md bg-white text-sm shadow-floating ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-black dark:ring-washed-dark",
                  anchor === "right"
                    ? "right-0"
                    : anchor === "left"
                      ? "left-0"
              ...
              >
                ...
                <Button
                  className="btn w-full px-4 py-3 text-dim hover:text-black dark:hover:text-white"
                  onClick={onReset}
