      ...
      {multiple && (
        <span className="absolute inset-y-0 left-3 flex items-center">
          <input
            ...
            className="dark:border-outlineHover-dark h-4 w-4 rounded border-outline text-primary focus:ring-0 dark:bg-washed-dark dark:checked:border-primary dark:checked:bg-primary-dark"
          />
        </span>
      )}
        ...
        <div className="relative text-sm">
          <Listbox.Button
            className={clx(
              ...
              "select-none bg-white active:bg-washed dark:bg-black hover:dark:bg-washed-dark/50 active:dark:bg-washed-dark",
              "hover:border-outlineHover hover:dark:border-outlineHover-dark border border-outline outline-none dark:border-washed-dark",
              disabled &&
                "disabled:text-outlineHover dark:disabled:text-outlineHover-dark disabled:pointer-events-none disabled:cursor-not-allowed disabled:border-outline disabled:bg-outline dark:disabled:border-washed-dark dark:disabled:bg-washed-dark",
              width,
              className,
            )}
          >
            <>
              ...
              {/* Sublabel */}
              {sublabel && (
                <span className="block w-fit min-w-min truncate text-dim">
                  {sublabel}
                </span>
              )}
          ...
          >
            <Listbox.Options
              ref={optionsRef}
              className={clx(
                "absolute z-20 mt-1 rounded-md bg-white text-black shadow-floating ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-black dark:text-white dark:ring-washed-dark",
            ...
            >
              ...
              {description && (
                <p className="px-3 pb-1 pt-2 text-xs text-dim">{description}</p>
              )}
              ...
              {enableClear && (
                <button
                  ...
                  className="group relative flex w-full cursor-default select-none items-center gap-2 border-t py-3 pl-10 pr-4 text-dim hover:bg-washed disabled:cursor-not-allowed disabled:opacity-50 dark:border-washed-dark dark:hover:bg-washed-dark"
