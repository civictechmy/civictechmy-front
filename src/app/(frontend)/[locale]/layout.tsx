...
export async function generateMetadata({
  ...
  return {
    title:
      siteInfo["site-meta"]["site-name"] ||
      "Civic Technology Community Malaysia",
    metadataBase: new URL("https://civictech.my"),
    description:
      siteInfo["site-meta"]["site-description"] ||
      "Mencipta produk digital untuk rakyat Malaysia",
    openGraph: {
      images: [
        {
          url: `/og_${locale}.png`,
          width: 1200,
          height: 630,
          alt: siteInfo["site-meta"]["site-name"] || "Default OG image",
        },
      ],
    },
  };
